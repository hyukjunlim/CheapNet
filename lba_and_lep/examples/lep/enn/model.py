...
class ENN_LEP(CGModule):
    """
    Siamese Cormorant Network used to train on LEP.
    ...
    def forward_once(self, data):
        ...
        return prediction, atoms_all, edges_all, atom_mask, edge_mask
    ...
    def forward(self, data, covariance_test=False):
        ...
        prediction1, atoms_all1, edges_all1, atom_mask1, edge_mask1 = self.forward_once(data1)
        prediction2, atoms_all2, edges_all2, atom_mask2, edge_mask2 = self.forward_once(data2)
