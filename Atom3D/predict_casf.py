...
import pandas as pd
import torch
from Atom3D import Atom3D, CheapNetAtom3D
...
for red_node in [1]:
    ...
    casf2016_df = pd.read_csv(os.path.join(data_root, 'test2016.csv'))
    ...
    models = ['Atom3D']
    # model_root = 'model/Atom3D_0'
    model_root = 'model/cheap-Atom3D_0'
    ...
    for model_name in models:
        ...
        for md in model_dir:
            ...
            model = CheapNetAtom3D(35, 64).to(device)
            # model = Atom3D(35, 64).to(device)
