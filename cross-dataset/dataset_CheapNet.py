...
class GraphDataset(Dataset):
    ...
    """
    def __init__(self, data_dir, data_df, dis_threshold=5, graph_type='Graph_CheapNet', num_process=8, create=False):
...
if __name__ == '__main__':
    ...
    toy_set = GraphDataset(toy_dir, toy_df, graph_type='Graph_CheapNet', dis_threshold=5, create=True)
